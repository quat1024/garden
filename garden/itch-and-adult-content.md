...
[Itch has not denied any payouts](https://bsky.app/profile/itch.io/post/3luq77xpjjc2y).
...
For example; see the MasterCard Rules, which can be found [here](https://www.mastercard.com/content/dam/mccom/shared/business/support/rules-pdfs/mastercard-rules.pdf) (PDF link), section 5.12.8 under "Additional U.S. Region and U.S. Territory Rules".
...
They cannot go on their blog and write freely about how much Mastercard sucks. Mentioning activist groups like *Collective Shout* at *all* in [their blog post](https://itch.io/updates/update-on-nsfw-content) is unprecedented.

## Poor disclosure timeline

Yes, it sucks that people were not given more warning. This situation was [addressed in the blog post](https://itch.io/updates/update-on-nsfw-content) as well.
...
[Seems great](https://bsky.app/profile/wechange.me/post/3lupiph5jls2o)!
...
You're looking at `@itchio.bsky.social`, which is a fake. The real account is [@itch.io](https://bsky.app/profile/itch.io).

## They "support AI" now

They briefly had a bluesky post up along the lines of "this is a difficult time for itch, if you're looking for something to do we like [this post](https://old.reddit.com/r/itchio/comments/1m83s71/things_you_can_do_to_counteract_payment/)", although it's deleted now so I don't remember the exact verbiage.
