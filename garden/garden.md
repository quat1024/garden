...
is a [handful of Markdown files assembled with `pandoc` and a shitty Makefile](https://github.com/quat1024/garden). I edit it with vscode. It's hosted via github pages; CI runs `make` and serves the contents of the `out` directory. This is fairly spartan; that is intentional.
